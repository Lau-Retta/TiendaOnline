...
namespace CapaNegocio
{
    public class CN_Producto
    {
        ...
        public int Registrar(Producto obj, out string Mensaje)
        {
            ...
            {
                Mensaje = "Debe seleccioonar una marca";
            }
            else if (obj.oCategoria.IdCategoria == 0)
            {
                Mensaje = "Debe seleccioonar una categoria";
            }
            else if (obj.Precio == 0)
            {
                Mensaje = "Debe ingrear precio al producto";
            }
            else if (obj.Stock == 0)
            {
        ...
        public bool GuardarImagen(Producto obj, out string Mensaje) {
            ...
            return objCapaDato.GuardarImagen(obj, out Mensaje);
        }
